...
import fashionPhoto from '../assets/about-red.JPG'
...
export default function About() {
  return (
    <section
      id="about"
      className="relative min-h-screen flex items-center justify-center px-8 md:px-20 py-32"
    ...
    >
      ...
      <div className="w-full max-w-7xl">
        ...
        {/* MOBILE layout — side by side mini photos + text below */}
        <div className="block md:hidden">
          ...
          >
            ...
            <p className="leading-relaxed text-sm mb-4" style={{ color: 'var(--lunar-white)', opacity: 0.75 }}>
            ...
            <p className="leading-relaxed text-sm mb-10" style={{ color: 'var(--lunar-white)', opacity: 0.75 }}>
            ...
            <div className="grid grid-cols-2 gap-4">
              {FACTS.map((fact, i) => (
                ...
                >
                  <p className="font-mono-accent text-xs tracking-widest mb-1" style={{ color: 'var(--saffron-pulse)' }}>
                    {fact.label.toUpperCase()}
                  </p>
                  <p className="text-sm" style={{ color: 'var(--lunar-white)', opacity: 0.85 }}>
                    {fact.value}
                  </p>
                </motion.div>
              ))}
        ...
        <div className="hidden md:grid md:grid-cols-[1fr_1.3fr_1fr] gap-8 items-center">
          ...
          >
            ...
            <p className="leading-relaxed text-sm md:text-base mb-0" style={{ color: 'var(--lunar-white)', opacity: 0.75 }}>
              I'm a Bengali-American cyber operator serving in the United States Space Force,
              defending the world's satellites, while modeling and creating content.
            </p>
            <p className="leading-relaxed mb-12 mt-6 text-sm md:text-base" style={{ color: 'var(--lunar-white)', opacity: 0.75 }}>
              I break barriers and refuse to exist in just one world.
            </p>
            <p className="leading-relaxed mb-16 text-sm md:text-base" style={{ color: 'var(--lunar-white)', opacity: 0.75 }}>
              I build full-stack projects, create content around beauty, fashion, and wellness,
              and bring both precision and artistry to everything I do.
            </p>
